...
#Algorithm to show configuration of a 2^n x 2^n -1 matrix, filled with pieces of the type:
#[ 1 , -1 ]
#[ 1 ,  1 ]
...
#Coding of parts to add color:
numeroPeca = 1

#Basic part
tiposPecas = [0 for i in range(size)]
...
tabuleiro = criaTabuleiro(size)
tabuleiro = preenche(tabuleiro, size)
